...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (commitDiff) {
                const messages = (_b = (_a = commitDiff === null || commitDiff === void 0 ? void 0 : commitDiff.data) === null || _a === void 0 ? void 0 : _a.files) === null || _b === void 0 ? void 0 : _b.filter((fileData) => langFiles.includes(fileData.filename)).map((fileData) => getMessages((fileData === null || fileData === void 0 ? void 0 : fileData.patch) || ''));
                const haveMessagesWithDeletedTranslations = messages === null || messages === void 0 ? void 0 : messages.some((messages) => (messages === null || messages === void 0 ? void 0 : messages.length) > 0);
