...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (commitDiff) {
                const listOfMessages = (_c = (_b = (_a = commitDiff === null || commitDiff === void 0 ? void 0 : commitDiff.data) === null || _a === void 0 ? void 0 : _a.files) === null || _b === void 0 ? void 0 : _b.filter((fileData) => langFiles.includes(fileData.filename))) === null || _c === void 0 ? void 0 : _c.map((fileData) => getMessages((fileData === null || fileData === void 0 ? void 0 : fileData.patch) || ''));
                const haveMessagesWithDeletedTranslations = listOfMessages === null || listOfMessages === void 0 ? void 0 : listOfMessages.some((messages) => (messages === null || messages === void 0 ? void 0 : messages.length) > 0);
                if (haveMessagesWithDeletedTranslations) {
                    throw new Error('You have deleted translations for: ' + ((_d = listOfMessages === null || listOfMessages === void 0 ? void 0 : listOfMessages.filter((messages) => (messages === null || messages === void 0 ? void 0 : messages.length) > 0)) === null || _d === void 0 ? void 0 : _d.join(',')));
                }
            }
